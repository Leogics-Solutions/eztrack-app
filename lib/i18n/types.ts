...
export interface Translations {
  ...
  settings: {
    ...
    integrations: {
      ...
      gmail: {
        ...
        smartIngestionDescription: string;
        schedulerNote: string;
        ingestKeywords: string;
        ingestKeywordsDescription: string;
        legacyIngestKeywords: string;
        legacyIngestKeywordsDescription: string;
        saveKeywords: string;
  ...
  jobs: {
    ...
    messagesClassified: string;
    attachmentsIngested: string;
    attachmentsSkipped: string;
    jobsEnqueued: string;
    emailIngestionHistory: string;
    emailIngestionHistoryDescription: string;
    receivedAt: string;
    from: string;
    subject: string;
